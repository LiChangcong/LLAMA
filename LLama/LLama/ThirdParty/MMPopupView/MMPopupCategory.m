...
static char const *mm_dimBackgroundColorKey = "mm_dimBackgroundColorKey";
...
- (UIColor *)mm_dimBackgroundColor {
    UIColor *backgroundColor = objc_getAssociatedObject(self, mm_dimBackgroundColorKey);
    if (!backgroundColor){
        backgroundColor = MMHexColor(0x0000007F);
        
        objc_setAssociatedObject(self, mm_dimBackgroundColorKey, backgroundColor, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    return backgroundColor;
}

- (void)setMm_dimBackgroundColor:(UIColor *)mm_dimBackgroundColor {
    objc_setAssociatedObject(self, mm_dimBackgroundColorKey, mm_dimBackgroundColor, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
...
- (void)mm_showDimBackground
{
    ...
    [UIView animateWithDuration:self.mm_dimAnimationDuration
                     ...
                     animations:^{
                         ...
                         self.mm_dimBackgroundView.backgroundColor = self.mm_dimBackgroundColor;
