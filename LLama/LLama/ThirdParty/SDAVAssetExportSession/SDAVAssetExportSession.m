...
//		transform = CGAffineTransformConcat(transform, matrix);
        ...
        //
        CGAffineTransform layerTransform = CGAffineTransformMake(videoTrack.preferredTransform.a, videoTrack.preferredTransform.b, videoTrack.preferredTransform.c, videoTrack.preferredTransform.d, videoTrack.preferredTransform.tx * ratio, videoTrack.preferredTransform.ty * ratio);
        
        layerTransform = CGAffineTransformConcat(layerTransform, CGAffineTransformMake(1, 0, 0, 1, -_trimEdgeInsets.left*naturalSize.width*ratio, -_trimEdgeInsets.top*naturalSize.height*ratio));//向上移动取中部影响
        transform = CGAffineTransformScale(layerTransform, ratio, ratio);
