...
+ (NSValueTransformer<MTLTransformerErrorHandling> *)mtl_validatingTransformerForClass:(Class)modelClass {
	...
	return [MTLValueTransformer transformerUsingForwardBlock:^ id (id value, BOOL *success, NSError **error) {
		if (value != nil && ![value isKindOfClass:modelClass]) {
            ...
            if ([modelClass isSubclassOfClass:[NSString class]] && [value isKindOfClass:[NSValue class]]) {
                return [value stringValue];
            }else if ([modelClass isSubclassOfClass:[NSValue class]] && [value isKindOfClass:[NSString class]]) {
