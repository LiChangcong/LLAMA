...
- (void)setAnimationRightTick:(BOOL)animationRightTick{
    ...
    if (animationRightTick) {
        [self.tickImageView setImage:[UIImage imageNamed:@"chosepicdoth"] forState:UIControlStateNormal];
    }else{
        [self.tickImageView setImage:[UIImage imageNamed:@"chosepicdot"] forState:UIControlStateNormal];
    }
