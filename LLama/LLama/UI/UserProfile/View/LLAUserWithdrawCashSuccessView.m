//
//  LLAUserWithdrawCashSuccessView.m
//  LLama
//
//  Created by Live on 16/1/26.
...
@interface LLAUserWithdrawCashSuccessView()
{
...
@implementation LLAUserWithdrawCashSuccessView
...
-  (void) initSubViews {
    ...
    [mentionButton setTitle:@"  提现成功" forState:UIControlStateNormal];
    ...
    mentionContentLabel.text = @"三个工作日内到帐，请注意查收如有问题请联系LLama小客服";
