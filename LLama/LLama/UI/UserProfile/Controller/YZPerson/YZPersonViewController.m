...
- (IBAction)likeButtonClick:(UIButton *)sender {
    ...
    TMLikeViewController *like = [[TMLikeViewController alloc] init];
...
- (IBAction)purseButtonClick:(UIButton *)sender {
    ...
    TMPurseViewController *purse = [[TMPurseViewController alloc] init];
    [self.navigationController pushViewController:purse animated:YES];
    
}

- (IBAction)uploadVideoButtonClick:(UIButton *)sender {
