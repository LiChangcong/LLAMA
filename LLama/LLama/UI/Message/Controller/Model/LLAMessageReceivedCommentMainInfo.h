//
//  LLAMessageReceivedCommentMainInfo.h
//  LLama
//
...
@interface LLAMessageReceivedCommentMainInfo : MTLModel<MTLJSONSerializing>
 ...
 *
 */
@property(nonatomic , strong) NSMutableArray<LLAMessageReceivedCommentItemInfo *> *dataList;
/**
 *  是否是第一页
 */
