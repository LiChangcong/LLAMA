//
//  LLAMessageReceivedCommentMainInfo.m
//  LLama
//
...
@implementation LLAMessageReceivedCommentMainInfo
...
+ (NSValueTransformer *)dataListJSONTransformer {
    return [MTLJSONAdapter arrayTransformerWithModelClass:[LLAMessageReceivedCommentItemInfo class]];
}
