//
//  LLAMessageReceivedPraiseMainInfo.m
//  LLama
//
...
@implementation LLAMessageReceivedPraiseMainInfo
...
+ (NSValueTransformer *)dataListJSONTransformer {
    return [MTLJSONAdapter arrayTransformerWithModelClass:[LLAMessageReceivedPraiseItemInfo class]];
}
