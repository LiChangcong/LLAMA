...
@interface LLAMessageOrderAideController()<UITableViewDataSource,UITableViewDelegate,LLAMessageOrderAideCellDelegate>
{
    ...
    LLAMessageReceivedOrderMainInfo *mainInfo;
...
- (void) loadData {
    ...
    [paramDic setValue:@"ORDER" forKey:@"type"];
    ...
    [LLAHttpUtil httpPostWithUrl:@"/message/getNotifyByType" param:paramDic responseBlock:^(id responseObject) {
        ...
        LLAMessageReceivedOrderMainInfo *tempInfo = [LLAMessageReceivedOrderMainInfo parseJsonWithDic:responseObject];
        if (tempInfo){
            mainInfo = tempInfo;
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //
    LLAMessageReceivedOrderItemInfo *orderItem = mainInfo.dataList[indexPath.row];
